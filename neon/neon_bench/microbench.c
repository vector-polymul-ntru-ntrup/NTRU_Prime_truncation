...
int main(void){
    ...
    //     __asm_rader17_primitive(poly1_NTT, poly1, twiddle_rader17_permuted, const_buff);
    //     time1 = hal_get_time();
    //     cycles[i] = time1 - time0;
    // }
    // qsort(cycles, sizeof(uint64_t), ITERATIONS, cmp_uint64);
    // printf("__asm_rader17_primitive (x8) cycles: ");
    // printf("%lu, %lu, %lu\n",
    ...
    // }
    // qsort(cycles, sizeof(uint64_t), ITERATIONS, cmp_uint64);
    // printf("__asm_3x2_twistx2 (x8) cycles: ");
    // printf("%lu, %lu, %lu\n",
    //         cycles[ITERATIONS >> 2], cycles[ITERATIONS >> 1], cycles[(ITERATIONS >> 1) + (ITERATIONS >> 2)]);
    ...
    // }
    // qsort(cycles, sizeof(uint64_t), ITERATIONS, cmp_uint64);
    // printf("__asm_cyclic_Toeplitz16_doubling_full (x8) cycles: ");
    // printf("%lu, %lu, %lu\n",
    //         cycles[ITERATIONS >> 2], cycles[ITERATIONS >> 1], cycles[(ITERATIONS >> 1) + (ITERATIONS >> 2)]);
    ...
    // }
    // qsort(cycles, sizeof(uint64_t), ITERATIONS, cmp_uint64);
    // printf("__asm_negacyclic_Toeplitz16_doubling_full (x8) cycles: ");
    // printf("%lu, %lu, %lu\n",
    //         cycles[ITERATIONS >> 2], cycles[ITERATIONS >> 1], cycles[(ITERATIONS >> 1) + (ITERATIONS >> 2)]);
    ...
    // }
    // qsort(cycles, sizeof(uint64_t), ITERATIONS, cmp_uint64);
    // printf("__asm_irader17_primitive (x8) cycles: ");
    // printf("%lu, %lu, %lu\n",
    //         cycles[ITERATIONS >> 2], cycles[ITERATIONS >> 1], cycles[(ITERATIONS >> 1) + (ITERATIONS >> 2)]);
